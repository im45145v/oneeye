...
import { UserProps, WithPageAuthRequiredOptions as WithPageAuthRequiredCSROptions, WithPageAuthRequiredProps } from '../frontend/with-page-auth-required';
...
export declare type WithPageAuthRequired = {
    <P extends WithPageAuthRequiredProps>(Component: ComponentType<P & UserProps>, options?: WithPageAuthRequiredCSROptions): React.FC<P>;
